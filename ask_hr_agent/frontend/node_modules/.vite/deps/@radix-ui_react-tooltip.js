...
function createSlot2(ownerName) {
  ...
  const Slot22 = React8.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime5.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React8.isValidElement(newElement) ? React8.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React12.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime9.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React12.isValidElement(newElement) ? React12.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var PopperAnchor = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime11.jsx)(Primitive3.div, { ...anchorProps, ref: composedRefs });
  }
);
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React16.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime12.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React16.isValidElement(newElement) ? React16.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React16.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var Portal = React18.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime14.jsx)(Primitive4.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React19.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime15.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React19.isValidElement(newElement) ? React19.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React19.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React24.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime17.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React24.isValidElement(newElement) ? React24.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Slottable6 = createSlottable6("Slottable");
function isSlottable6(child) {
  return React24.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var Primitive6 = NODES6.reduce((primitive, node) => {
  const Slot7 = createSlot6(`Primitive.${node}`);
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React27.useRef(true);
  const isPointerInTransitRef = React27.useRef(false);
  ...
  return (0, import_jsx_runtime20.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React27.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React27.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React27.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React27.useRef(false);
  ...
  const stateAttribute = React27.useMemo(() => {
  ...
  return (0, import_jsx_runtime20.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime20.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React27.useCallback(() => {
...
var TooltipTrigger = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const handlePointerUp = React27.useCallback(() => isPointerDownRef.current = false, []);
    React27.useEffect(() => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime20.jsx)(PortalProvider, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime20.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime20.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var TooltipContentHoverable = React27.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React27.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React27.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React27.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React27.useCallback(
    (event, hoverTarget) => {
...
var Slottable7 = createSlottable5("TooltipContent");
var TooltipContentImpl = React27.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime20.jsxs)(
          Content,
          {
            ...
            children: [
              (0, import_jsx_runtime20.jsx)(Slottable7, { children }),
